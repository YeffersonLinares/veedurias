...
class CreateVeeduriaSoporteTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('dinamico')->create('veeduria_soporte', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('dinamico')->dropIfExists('veeduria_soporte');
    }
}
