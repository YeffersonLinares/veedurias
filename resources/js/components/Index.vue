    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Tipo de identificación
          <button
            type="button"
              ...
              >
                <td>
                  <button
                    type="button"
                    @click="
                      abrirModal('departamento', 'actualizar', departamento)
                    "
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              >
                ...
                <div
                  v-show="errorDepartamento"
                  class="form-group row div-error"
                >
                  <div class="text-center text-error">
                    <div
                      v-for="error in errorMostrarMsjDepartamento"
                      :key="error"
                      v-text="error"
                    ></div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    registrarDepartamento() {
      ...
      axios.post("/crear_tipoDocumento", {
          nombre: this.nombre,
        })
        .then((response) => {
          this.cerrarModal();
    ...
    actualizarDepartamento() {
      ...
      axios
        .put(this.ruta + "/departamento/update", {
          idpais: this.idpais,
          nombre: this.nombre,
    ...
    desactivarDepartamento(id) {
      swal
        ...
        .then((result) => {
          if (result.value) {
            axios
              .put(this.ruta + "/departamento/inactivar", {
                id: id,
              })
              .then((response) => {
                this.listarDepartamento(1, "", "nombre");
    ...
    activarDepartamento(id) {
      swal
        ...
        .then((result) => {
          if (result.value) {
            axios
              .put(this.ruta + "/departamento/activar", {
                id: id,
              })
              .then((response) => {
                this.listarDepartamento(1, "", "nombre");
    ...
    validarDepartamento() {
      ...
      if (!this.nombre)
        this.errorMostrarMsjDepartamento.push(
  ...
  mounted() {
    ...
    axios
      .get(this.ruta + "/menus/getRutaRelativa?ruta=" + this.$route.name)
      .then((response) => {
        this.arrayRuta = response.data;
      });
  },
};
</script>
