        ...
        <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Tipos de veeduría
                            ...
                            <tbody>
                                <tr v-for="departamento in arrayDepartamento" :key="departamento.id">
                                    <td>
                                        ...
                                        <template v-if="departamento.estado == '1'">
                                    ...
                                    <td>
                                        <div v-if="departamento.estado == '1'">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Nombre de tipo de veeduría">
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods : {
            listarDepartamento (page,buscar,criterio){
                var url= this.ruta + '/tipo_veeduria?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            registrarDepartamento(){
                ...
                axios.post(this.ruta + '/tipo_veeduria/store',{
                    'nombre': this.nombre
                }).then( (response) => {
                    this.cerrarModal();
                    Swal.fire(
            ...
            actualizarDepartamento(){
               if (this.validarDepartamento()){
                ...
                axios.put(this.ruta + '/tipo_veeduria/update',{
                    'idpais': this.idpais,
                    'nombre': this.nombre,
            ...
            desactivarDepartamento(id){
               swal.fire({
                title: '¿Está seguro de desactivar este tipo de veeduría?',
                type: 'warning',
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta + '/tipo_veeduria/inactivar',{
                        'id': id
                    }).then((response) => {
                        this.listarDepartamento(1,'','nombre');
                        swal.fire(
            ...
            activarDepartamento(id){
               swal.fire({
                title: '¿Está seguro de activar este tipo de veeduría?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta + '/tipo_veeduria/activar',{
                        'id': id
                    }).then((response) => {
                        this.listarDepartamento(1,'','nombre');
                        swal.fire(
                ...
                switch(modelo){
                    case "departamento":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar tipo de veeduría';
                                this.nombre= '';
                                this.tipoAccion = 1;
                                break;
                            }
                            case 'actualizar':
                            {
                                //console.log(data);
                                this.modal=1;
                                this.tituloModal='Actualizar tipo de veeduría';
                                this.tipoAccion=2;
